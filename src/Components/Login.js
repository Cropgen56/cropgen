...
const LoginSignup = () => {
 ...
 const handleLogin = async (values) => {
  setLoading(true);
  try {
    const response = await axios.post('https://first-project-jx9w.onrender.com/login', {
      email: values.email,
 ...
 // Function to handle signup
  ...
  return (
    <div style={{ display: 'flex', height: '100vh' }}>
      ...
      <div style={{ width: '55%', display: 'flex', flexDirection: 'column', backgroundColor: '#075A53' }}>
      <div style={{ position: 'absolute', top: 20, right: 20 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', position: 'absolute', top: 100, right:150}}>
          <div style={{ width: '100%', height: '100%'}}>
            <div style={{ backgroundColor: '#2E7670', borderRadius: '20px', border: 'solid 2px #fff', width: 500, height:'auto'}}>
              ...
              <div style={{ display: 'flex', marginBottom: '10px'}}>
                <Button
                  type="text" htmlType="submit" block loading={loading}
              ...
              {isLogin ? <SignupForm onSignup={handleSignup} /> : <LoginForm onLogin={handleLogin} loading={loading}/>}
              </div>
            </div>
          </div>
        </div>
